...
namespace InnovoAssignment.Utilities
{
    public class StringConstants
    {
        ...
        public const string EMAIL_FROM_ADDRESS_USERNAME = "innovoassignment@gmail.com";

     

        public const string EMAIL_PASSWORD = "inn1234#";
        public const string SMTP_SERVER = "smtp.gmail.com";

        public const string USER_ID = "session.userid";
